$(document).ready(function() {
  ...
  function answerCorrect() {
    ...
    $(".alert").html('correct!!!' + '<br><img src="https://media1.giphy.com/media/l49JHLpRSLhecYEmI/giphy-downsized.gif">');
  }

  function answerWrong() {
    wrong++;
    console.log("wrong");
    $(".alert").html('incorrect!!!' +" The answer was " + questionArray[index].answer + '<img src="https://78.media.tumblr.com/368d89af7f369de7050e7f82bc602474/tumblr_otz9h74UV41vw8qgmo1_500.gif">');
  ...
  function showScore() {
    ...
    $('.question').append('<button><a href="javascript:location.reload(true)">restart</a></button>');
